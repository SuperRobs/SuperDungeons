...
public record FeatureIdentifier(
    ...
    string Title,
    //A ClassFeature's source should be the class Identifier, a Feat feature's source should be the feat name, these 
    //have to be unique TODO this should be enforced by the content loader
    string Source);